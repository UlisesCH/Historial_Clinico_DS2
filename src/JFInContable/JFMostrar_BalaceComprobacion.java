 ...
 * @author ulise
 */
public class JFMostrar_BalaceComprobacion extends javax.swing.JFrame {

    /**
     * Creates new form JFMostrar_BalaceComprobacion
     */
    public JFMostrar_BalaceComprobacion() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFMostrar_BalaceComprobacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFMostrar_BalaceComprobacion().setVisible(true);
            }
        });
    }
