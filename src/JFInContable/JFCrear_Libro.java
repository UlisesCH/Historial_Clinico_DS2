 ...
 * @author ulise
 */
public class JFCrear_Libro extends javax.swing.JFrame {

    /**
     * Creates new form JFCrear_Libro
     */
    public JFCrear_Libro() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("CREAR NUEVO LIBRO DIARIO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFCrear_Libro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFCrear_Libro().setVisible(true);
                //OBJETO PARA ENTERACTUAR CON LA CONEXION
                Conexion conec = new Conexion();
                //CREA REALIZA LA CONEXION Y CREA LA TABLA SI NO HAY
                conec.CrearTablas();
