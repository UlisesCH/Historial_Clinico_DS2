...
public class CRUD_CuentasContable {
    ...
    public static List<InCuentasContable> listaCuentas = new ArrayList<InCuentasContable>();
    ...
    public static void LlenarTabla(){
        ...
        try{
            ...
            PreparedStatement st = conec.conexion.prepareStatement("select ID, Grupo_Cuenta, Tipo_Cuenta, SubGrupo_Cuenta, Nombre_Cuenta from TBL_CuentasContable");
            ...
            while(result.next()){
                ...
                InCuentasContable inCuentas = new InCuentasContable(result.getInt("ID"),
